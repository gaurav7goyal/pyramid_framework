...
from .models import DBSession, Page,Mytable
...
class WikiViews(object):
    ...
    def wiki_view(self):
        ...
        mytable=DBSession.query(Mytable)
        return dict(title='Wiki View', pages=pages,mytable=mytable)
    ...
    def wikipage_add(self):
        ...
        if 'submit' in self.request.params:
            ...
            with transaction.manager:
                insert_data = Page(title=new_title, body=new_body)
                DBSession.add(insert_data)
